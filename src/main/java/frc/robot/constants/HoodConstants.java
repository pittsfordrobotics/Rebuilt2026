...
public class HoodConstants {
    ...
    public static final double HUB_DISTANCE_FOR_NEAR_SHOOTING_INCHES = 90; // Should be moved closer - 60?
    public static final double CLOSE_SHOOTING_SETPOINT = 0.2; // Should be changed back to 0.2
